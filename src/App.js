...
//       {dataLoaded && (
//         <div className="shrink-0 mb-4 flex space-x-2">
//           <button
...
//         <div className="shrink-0 mb-4 max-h-48 overflow-y-auto bg-white rounded-lg shadow">
...
//                   <div
//                     id={message.chartId}
//                     className="mt-4 bg-white rounded p-4 shadow-sm"
//                     style={{ 
//                       width: '500px', 
//                       height: '300px'
//                     }}
      ...
      <div className="flex-1 bg-white rounded-lg shadow-sm flex flex-col min-h-0">
        <div className="flex-1 overflow-y-auto p-4 space-y-8">
          {messages.map((message, index) => (
            <div
              key={index}
              className={`${message.chartSpec ? 'mb-24' : 'mb-8'} ${
            ...
            >
              ...
              >
                ...
                {message.chartSpec && (
                  <div
                    id={message.chartId}
                    className="mt-8 bg-white rounded p-4 shadow-sm"
                    style={{ 
                      width: '500px', 
                      height: '300px',
                      marginBottom: '3rem'
